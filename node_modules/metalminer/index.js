(function () {
    ...
    mm.getLyrics = function (metaInfo, callback) {
        ...
        var callback2 = function (err, res) {
            ...
            console.log(statuses.length + " : " + statuses.filter(function (single) { return single === "DONE"; }).length);
    ...
    mm.getDarkLyrics = function (metaInfo, callback) {
    ...
    mm.getMetalLyrics = function (metaInfo, callback) {
        if (!metaInfo || !callback) {
            return;
        }
        var that = this;
    ...
    mm.getSongLyrics = function (metaInfo, callback) {
        if (!metaInfo || !callback) {
            return;
        }
        var that = this;
