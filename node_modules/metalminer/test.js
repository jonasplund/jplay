 (function () {
    ...
    function setlistTest() { 
        for (var i = 0, endi = testobjects.length; i < endi; i++) {
            (function (i) {
                var testobject = testobjects[i];
                setlist.setlistfm(testobject, function (err, res) {
                    if (res.error) {
                        console.log(yellow + 'setlistTest: setlistfm' + red + ' not found for object: ' + reset);
                        console.log(testobject);
                        console.log(res.error);
                    } else {
                        if (!res.data) { 
                            console.log(red + 'setlistTest: No error or result for setlistfm for object: ' + reset);
                            console.log(testobject);
                        }
                    }
                });
        ...
        setlist.setlistfm(errorobj, function (err, res) { if (!res.error) { console.log(yellow + 'setlist: setlistfm' + red + ' did not report error for errorobj:' + reset); console.log(res); } });
    }
